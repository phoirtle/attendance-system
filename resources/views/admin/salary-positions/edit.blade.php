@extends('layouts.app')
@section('title', 'Edit Salary Position — Heartstrings')
...
<div style="max-width:600px;margin:0 auto;padding:24px 20px 48px;">
    ...
    <div class="fade-in" style="margin-bottom:28px;">
        ...
        <h1 style="font-family:'Playfair Display',serif;font-size:2rem;font-weight:600;color:#3d1a22;margin:0;letter-spacing:-0.02em;">Edit <em>Position</em></h1>
    </div>

    <div class="glass-strong panel fade-in delay-1">
        <form method="POST" action="{{ route('admin.salary-positions.update', $salaryPosition) }}">
            @csrf
            @method('PUT')

            <div style="margin-bottom:18px;">
                <label style="display:block;font-size:0.82rem;font-weight:600;color:#3d1a22;margin-bottom:6px;">Position Name</label>
                <input type="text" name="position_name" value="{{ old('position_name', $salaryPosition->position_name) }}" class="input-glass" placeholder="e.g. Software Engineer" required>
            ...
            <div style="margin-bottom:18px;">
                ...
                <input type="text" name="department" value="{{ old('department', $salaryPosition->department) }}" class="input-glass" placeholder="e.g. Engineering">
            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:24px;">
                <div>
                    ...
                    <input type="number" name="base_salary" value="{{ old('base_salary', $salaryPosition->base_salary) }}" class="input-glass" placeholder="5000000" min="0" required>
                ...
                <div>
                    ...
                    <input type="number" name="allowance" value="{{ old('allowance', $salaryPosition->allowance) }}" class="input-glass" placeholder="1000000" min="0" required>
