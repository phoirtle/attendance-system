<?php $__env->startSection('title', 'Profile — Heartstrings'); ?>
...
<div style="max-width:820px;margin:0 auto;padding:24px 20px 48px;">
        ...
        <div style="display:flex;align-items:center;gap:20px;">
            <div style="position:relative;">
                <?php if($user->photo_path): ?>
                    <img src="<?php echo e(asset('storage/' . $user->photo_path)); ?>" alt="<?php echo e($user->name); ?>"
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('profile.photo')); ?>" style="position:absolute;bottom:0;right:0;width:22px;height:22px;background:#BE0822;border-radius:50%;border:2px solid white;display:flex;align-items:center;justify-content:center;text-decoration:none;cursor:pointer;transition:transform 0.2s;" onmouseover="this.style.transform='scale(1.15)'" onmouseout="this.style.transform=''">
            ...
            <div>
                <div style="font-size:1.3rem;font-weight:700;color:#3d1a22;"><?php echo e($user->name); ?></div>
                <div style="font-size:0.85rem;color:rgba(107,34,50,0.65);"><?php echo e($user->email); ?></div>
                <div style="margin-top:6px;display:flex;gap:8px;align-items:center;">
                    <span style="font-size:0.72rem;font-weight:600;letter-spacing:0.06em;text-transform:uppercase;background:rgba(190,8,34,0.10);color:#BE0822;padding:3px 10px;border-radius:20px;"><?php echo e(ucfirst($user->role)); ?></span>
                    <?php if($user->department): ?>
                    <span style="font-size:0.78rem;color:rgba(107,34,50,0.60);"><?php echo e($user->department); ?></span>
                    <?php endif; ?>
                </div>
            </div>
        </div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:14px;">
        ...
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$title, $route, $bg, $icon, $desc]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
        ...
        <a href="<?php echo e(route($route)); ?>"
           ...
           style="text-decoration:none;background:<?php echo e($bg); ?>44;display:flex;align-items:center;gap:16px;padding:20px;transition:transform 0.2s,box-shadow 0.2s;"
           ...
           onmouseout="this.style.transform='';this.style.boxShadow='';">
            <div style="width:46px;height:46px;background:linear-gradient(135deg,#BE0822,#E86975);border-radius:14px;display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 4px 14px rgba(190,8,34,0.30);">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="<?php echo e($icon); ?>"/></svg>
            </div>
            <div>
                <div style="font-size:0.92rem;font-weight:600;color:#3d1a22;"><?php echo e($title); ?></div>
                <div style="font-size:0.75rem;color:rgba(107,34,50,0.55);margin-top:2px;"><?php echo e($desc); ?></div>
            </div>
    ...
    <div class="flash flash-error" style="margin-top:16px;"><?php echo e(session('error')); ?></div>
    <?php endif; ?>

</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Windows\Downloads\attendance-system\resources\views/profile/show.blade.php ENDPATH**/ ?>