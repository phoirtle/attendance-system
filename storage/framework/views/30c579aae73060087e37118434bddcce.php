...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Heartstrings — Attendance'); ?> </title>
...
<nav class="navbar">
    ...
    <a href="<?php echo e(auth()->user()->isAdmin() ? route('admin.dashboard') : route('attendance.index')); ?>"
    ...
    <a href="<?php echo e(auth()->user()->isAdmin() ? route('admin.dashboard') : route('attendance.index')); ?>"
       class="nav-link <?php echo e(request()->routeIs('admin.dashboard') || request()->routeIs('attendance.index') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('attendance.history')); ?>"
       class="nav-link <?php echo e(request()->routeIs('attendance.history') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('leaves.index')); ?>"
       class="nav-link <?php echo e(request()->routeIs('leaves.*') ? 'active' : ''); ?>">
    ...
    <a href="<?php echo e(route('admin.recap')); ?>"
       class="nav-link <?php echo e(request()->routeIs('admin.recap*') ? 'active' : ''); ?>">
    ...
    <?php if(auth()->user()->isAdmin()): ?>
    <a href="<?php echo e(route('admin.leaves')); ?>"
       class="nav-link <?php echo e(request()->routeIs('admin.leaves') ? 'active' : ''); ?>">
        <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
        Leaves
    </a>
    <?php endif; ?>
    ...
    <a href="<?php echo e(route('profile.show')); ?>"
       class="nav-link <?php echo e(request()->routeIs('profile.*') ? 'active' : ''); ?>">
        <?php if(auth()->user()->photo_path): ?>
            <img src="<?php echo e(asset('storage/' . auth()->user()->photo_path)); ?>" alt=""
                 style="width:22px;height:22px;border-radius:50%;object-fit:cover;">
        <?php else: ?>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
        <?php endif; ?>
        <span class="hidden sm:inline"><?php echo e(Str::words(auth()->user()->name, 1, '')); ?></span>
    </a>
...
<?php /**PATH C:\Users\Windows\Downloads\attendance-system\resources\views/layouts/app.blade.php ENDPATH**/ ?>