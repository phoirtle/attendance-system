<?php $__env->startSection('title', 'Admin Dashboard — Heartstrings'); ?>
...
<div style="max-width:1100px;margin:0 auto;padding:24px 20px 48px;">
    ...
    <div class="fade-in" style="margin-bottom:28px;">
        <p style="font-size:0.8rem;font-weight:600;letter-spacing:0.08em;text-transform:uppercase;color:rgba(107,34,50,0.55);margin:0 0 4px;"><?php echo e(now()->format('l, d F Y')); ?></p>
    ...
    <div style="display:grid;grid-template-columns:repeat(5,1fr);gap:14px;margin-bottom:20px;">
        ...
        ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$label, $val, $txtColor, $icon, $bg]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="glass-strong panel fade-in delay-1" style="background:<?php echo e($bg); ?>33;text-align:center;padding:22px 16px;">
            <div style="font-size:2rem;font-weight:800;color:<?php echo e($txtColor); ?>;line-height:1;"><?php echo e($val); ?></div>
            <div style="font-size:0.78rem;color:rgba(107,34,50,0.60);font-weight:500;margin-top:4px;letter-spacing:0.02em;"><?php echo e($label); ?></div>
        </div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1.6fr;gap:20px;">
            ...
            <div style="display:flex;align-items:center;justify-content:center;gap:24px;margin-top:16px;">
                ...
                <div style="position:relative;width:130px;height:130px;flex-shrink:0;">
                    <svg width="130" height="130" viewBox="0 0 100 100" style="transform:rotate(-90deg);">
                        ...
                        <circle cx="50" cy="50" r="42" fill="none" stroke="#7f0515" stroke-width="10"
                                stroke-dasharray="<?php echo e($dash); ?> <?php echo e($gap); ?>"
                                stroke-linecap="round"
                                style="transition:stroke-dasharray 1s ease;"/>
                    </svg>
                    <div style="position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;">
                        <div style="font-size:1.6rem;font-weight:800;color:#3d1a22;line-height:1;"><?php echo e($pct); ?>%</div>
                ...
                <div style="display:flex;flex-direction:column;gap:10px;">
                    <div>
                        ...
                        <div style="font-size:1.1rem;font-weight:700;color:#3d1a22;padding-left:17px;"><?php echo e($presentToday); ?></div>
                    </div>
                    <div>
                        <div style="display:flex;align-items:center;gap:7px;margin-bottom:2px;">
                        ...
                        <div style="font-size:1.1rem;font-weight:700;color:#3d1a22;padding-left:17px;"><?php echo e($absentToday); ?></div>
                    </div>
                    <div>
                        <div style="display:flex;align-items:center;gap:7px;margin-bottom:2px;">
                        ...
                        <div style="font-size:1.1rem;font-weight:700;color:#3d1a22;padding-left:17px;"><?php echo e($lateToday); ?></div>
                    </div>
                    <div>
                        <div style="display:flex;align-items:center;gap:7px;margin-bottom:2px;">
                        ...
                        <div style="font-size:1.1rem;font-weight:700;color:#3d1a22;padding-left:17px;"><?php echo e($leaveToday); ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="glass-strong panel fade-in delay-2" style="background:rgba(255,255,255,0.50);padding-top:36px;">
            ...
            <?php $maxLate = max(max(array_column($lateByDay, 'count') ?: [0]), 1); ?>
            <div style="display:flex;align-items:flex-end;gap:8px;height:160px;padding-bottom:28px;position:relative;margin-top:40px;">
                <?php $__currentLoopData = $lateByDay; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $h = $maxLate > 0 ? max(4, round($day['count'] / $maxLate * 90)) : 4; ?>
                <a href="<?php echo e(route('admin.recap', ['date' => $day['date']])); ?>"
                   ...
                   title="View attendance for <?php echo e($day['date']); ?>">
                    <div style="width:100%;height:<?php echo e($h); ?>px;background:linear-gradient(180deg,#BE0822,#E86975);border-radius:6px 6px 3px 3px;transition:height 0.8s ease,opacity 0.2s;position:relative;cursor:pointer;"
                         onmouseover="this.style.opacity='0.85'" onmouseout="this.style.opacity='1'">
                        <?php if($day['count'] > 0): ?>
                        <div style="position:absolute;top:-20px;left:50%;transform:translateX(-50%);font-size:0.75rem;font-weight:700;color:#3d1a22;"><?php echo e($day['count']); ?></div>
                        <?php endif; ?>
                    </div>
                    <div style="position:absolute;bottom:-22px;font-size:0.75rem;font-weight:600;color:#3d1a22;"><?php echo e($day['day']); ?></div>
                </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:14px;margin-top:20px;">
        <a href="<?php echo e(route('admin.recap')); ?>" class="glass panel fade-in delay-3"
        ...
        <a href="<?php echo e(route('admin.users.index')); ?>" class="glass panel fade-in delay-3"
           style="text-decoration:none;display:flex;align-items:center;gap:14px;padding:18px 20px;transition:transform 0.2s;" onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform=''">
            ...
            <div>
                ...
                <div style="font-size:0.75rem;color:rgba(107,34,50,0.55);"><?php echo e($totalUsers); ?> total employees</div>
            </div>
        </a>

        <a href="<?php echo e(route('admin.leaves')); ?>" class="glass panel fade-in delay-3"
           style="text-decoration:none;display:flex;align-items:center;gap:14px;padding:18px 20px;transition:transform 0.2s;" onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform=''">
            ...
            <div>
                ...
                <div style="font-size:0.75rem;color:rgba(107,34,50,0.55);"><?php echo e($pendingLeaves); ?> awaiting approval</div>
            </div>
        </a>

        <a href="<?php echo e(route('admin.recap', ['date' => now()->format('Y-m-d')])); ?>" class="glass panel fade-in delay-3"
           style="text-decoration:none;display:flex;align-items:center;gap:14px;padding:18px 20px;transition:transform 0.2s;" onmouseover="this.style.transform='translateY(-3px)'" onmouseout="this.style.transform=''">
            ...
            <div>
                ...
                <div style="font-size:0.75rem;color:rgba(107,34,50,0.55);"><?php echo e($presentToday); ?>/<?php echo e($totalUsers); ?> checked in</div>
            </div>
        </a>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Windows\Downloads\attendance-system\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>