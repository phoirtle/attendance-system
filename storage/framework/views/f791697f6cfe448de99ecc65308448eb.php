...
<?php $__env->startSection('title', 'Add Employee — Heartstrings'); ?>
    ...
    <div class="glass-strong panel fade-in delay-1">
        <form method="POST" action="<?php echo e(route('admin.users.store')); ?>">
            ...
            <div style="margin-bottom:16px;">
                ...
                <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="input-glass" placeholder="John Doe" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom:16px;">
                ...
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="input-glass" placeholder="john@company.com" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div style="margin-bottom:16px;">
                ...
                <input type="text" name="department" value="<?php echo e(old('department')); ?>" class="input-glass" placeholder="Engineering">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Windows\Downloads\attendance-system\resources\views/admin/users/create.blade.php ENDPATH**/ ?>